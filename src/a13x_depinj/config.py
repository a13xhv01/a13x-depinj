...
class Config:
    ...
    def load_config(cls, config_path: Optional[Union[str, Path]] = None) -> Config:
        ...
        Args:
            config_path: Path to configuration file. If None, searches in default locations.
            ...
            with cls._config_lock:
                if not cls._config:
                    ...
                    try:
                        ...
                        cls._config = yaml.safe_load(config_path.read_text(encoding='utf-8'))
    ...
    def reload(self, config_path: Optional[Union[str, Path]] = None) -> None:
        ...
        with self._config_lock:
            self._config.clear()
            load_config.cache_clear()  # Clear lru_cache
